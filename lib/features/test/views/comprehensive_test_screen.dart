...
class _ComprehensiveTestScreenState
                  ...
                  children: [
                    ...
                    ...answers.asMap().entries.map((e) {
                      ...
                      if (_answered) {
                        ...
                        } else if (i == _selected[_currentIndex]) {
  ...
  Widget _buildResult(BuildContext context) {
    final correctCount = _selected
        ...
        .length;
    final pct =
        (_questions.isEmpty ? 0 : (correctCount * 100 / _questions.length))
            .round();
    final rank = pct >= 90
        ? 'S'
        : pct >= 70
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      '$correctCount / ${_questions.length} 問正解',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                      ...
                      return Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                '問${i + 1}. ${(q['question'] as String).replaceAll(RegExp(r'\{([^|{}]+)\|([^}]+)\}'), r'$1')}',
