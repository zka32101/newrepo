...
class ClaudeApiClient {
  ...
  String _generateDummyResponse(String userMessage) {
    const response1 = '磁石は、北と南の2つの磁極を持った不思議な石です。'
        '同じ磁極同士は反発し、反対の磁極同士は引き付け合いますよ。';
    const response2 = '電気は、目には見えませんが、電子という小さな粒が動くことで作られます。'
        '雷も電気の仲間なんですよ。';
    const response3 = '植物は、太陽の光を使って、空気と水から栄養を作ります。'
        'これを光合成と言うんです。';
    const response4 = '星は遠くにある大きな火の玉で、太陽も実は星なんですよ。'
